...
const CreateTaskModal = ({ setShowModal }) => {
  ...
  return (
    <div className="fixed overflow-auto -top-20 left-0 right-0 bottom-0 z-[999] bg-white/80 flex justify-center items-center">
      <div className="w-[96%] md:w-[70%] lg:w-[60%] flex flex-col gap-y-6 bg-white shadow p-4 md:p-8 rounded-lg my-20 mt-96">
...
//   return (
//     <div className="absoulte top-0 left-0 bottom-0 right-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
//       <div className="relative w-[90%] max-w-lg md:max-w-2xl lg:max-w-3xl bg-white rounded-lg shadow-lg">
